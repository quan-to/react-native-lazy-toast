			...
			>
				...
				<Animated.View style={[styles.toast, animationStyle]}>
					...
					<Animated.View style={[styles.header, animatedText]}>
						<Text style={styles.headerStyle}>{message}</Text>
					</Animated.View>
					<View style={styles.actionContainer}>
						<Button onPress={this.showNotify} title="Cancel" color="gray" />
						<Button onPress={this.acceptAction} title="Accept" color={color} />
					</View>
				</Animated.View>
			</View>
		);
